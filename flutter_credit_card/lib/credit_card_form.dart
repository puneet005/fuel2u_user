...
class CreditCardForm extends StatefulWidget {
  ...
  // A String indication zip Code in the text field.
  ...
  final bool obscureCvv;
    ...
    /// When enabled Zip gets hidden with obscuring characters. Defaults to
  /// false.
  ...
  final GlobalKey<FormFieldState<String>>? cvvCodeKey;
   ...
   /// A FormFieldState key for zip code text field.
 ...
 /// A validator for zip code text field.
...
class _CreditCardFormState extends State<CreditCardForm> {
  ...
  // void textFieldFocusDidChangeOnZip() {
  //   creditCardModel.isCvvFocused = zipFocusNode.hasFocus;
  //   onCreditCardModelChange(creditCardModel);
  // }
  ...
  void createCreditCardModel() {
    ...
    creditCardModel = CreditCardModel(
        cardNumber, expiryDate, cardHolderName, cvvCode, zipCode, isCvvFocused);
  }
          ...
          children: <Widget>[
            ...
            Row(
              ...
              //  ZIP
                Expanded(
                  child: Visibility(
                    visible: widget.enableZip,
                    child: Container(
                      padding: const EdgeInsets.symmetric(vertical: 8.0),
                      margin:
                          const EdgeInsets.only(left: 16, top: 8, right: 16),
                      child: TextFormField(
                        key: widget.zipCodeKey,
                        obscureText: widget.obscureZip,
